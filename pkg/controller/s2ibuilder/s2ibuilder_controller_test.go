...
func TestReconcile(t *testing.T) {
	...
	instance := &devopsv1alpha1.S2iBuilder{ObjectMeta: metav1.ObjectMeta{Name: "foo", Namespace: "default"}}
	...
	// Create the S2iBuilder object and expect the Reconcile and Deployment to be created
