...
// +kubebuilder:webhook:verbs=create;update,path=/validate-devops-kubesphere-io-kubesphere-io-v1alpha1-s2irun,mutating=false,failurePolicy=fail,groups=devops.kubesphere.io.kubesphere.io,resources=s2iruns,versions=v1alpha1,name=vs2irun.kb.io
